...
use App\Models\Proposal\ProposalExpectedOutput;
use App\Models\Proposal\ProposalGADScore;
use Carbon\Carbon;
...
class DetailedProposalService
{
   ...
   {         
      ...
      else if ($proposal_type_id == 3 || $proposal_type_id == 4) {
         Proposal::find($id)->update([
            'program_id' => $request['program_id'],
            'title' => $request['title'],
            'resume_part' => 3,
