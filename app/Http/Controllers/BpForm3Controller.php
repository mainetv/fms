...
class BpForm3Controller extends Controller
{
    /**
    ...
    public function index($year_selected)
    {
        ...
        $bp_form3 = BpForm3Model::where('year', $year_selected)->where('is_active', 1)->where('is_deleted', 0)->get();

        return view('budget_preparation.bp_forms.bp_form3.fy_tabs')
            ...
            ->with(compact('bp_form3'), $bp_form3);
    }
    ...
    public function generatePDF(Request $request, $division_id, $year)
    {
        if ($request->ajax()) {
            ...
            return view('budget_preparation.bp_forms.bp_form3.pdf')
