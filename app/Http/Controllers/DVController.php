...
class DVController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            if ($request->add_dv == 1) {
                ...
                if ($validator->passes()) {
                    ...
                    return response()->json(['success' => 1, 'redirect_url' => route('dv.edit_division', [$data->id])], 200);
                }
                ...
                return response()->json(['success' => 1, 'dv_rs_id' => $data->id], 200);
    ...
    public function update(Request $request, DVModel $dVModel)
    {
        if ($request->ajax()) {
            ...
            if ($request->edit_dv == 1) {
                ...
                return Response::json(['errors' => $validator->errors()]);
            } elseif ($request->edit_attached_rs == 1) {
                ...
                return response()->json(['success' => 1, 200]);
            } elseif ($request->edit_attached_rs_net == 1) {
    ...
    public function show_rs_by_payee(Request $request)
    {
        ...
        if ($request->ajax() && isset($payee_id) && $payee_id != null) {
            ...
            } elseif (isset($payee_id) && ($payee_id == 3288 || $payee_id == 3289 || $payee_id == 3290 || $payee_id == 3616 || $payee_id == 3617 || $payee_id == 3618 || $payee_id == 3619 || $payee_id == 3620 || $payee_id == 3622 || $payee_id == 2789 || $payee_id == 3223 || $payee_id == 2623 || $payee_id == 2738 || $payee_id == 3267 || $payee_id == 2608 || $payee_id == 2754 || $payee_id == 3221 || $payee_id == 3268 || $payee_id == 3655 || $payee_id = 3656)) {
                $data = ViewRSbyPayeeModel::where('fund_id', $fund_id)
                   // ->where(function ($query) {
    ...
    public function show_dv_by_date(Request $request)
    {
        ...
        if ($request->ajax() && isset($date_selected) && $date_selected != null && ($search == null || $search == '')) {
            ...
            $data = ViewDVModel::where(function ($query) use ($search) {
