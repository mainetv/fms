...
class RsTransactionTypeSeeder extends Seeder
{
   public function run(): void
   {
      $connection = env('DB_CONNECTION', 'mysql');
      $csvFile = database_path('seeders/csv/rs_transaction_type.csv');
      ...
      foreach ($csv as $row) {
         DB::connection($connection)->table('rs_transaction_type')->updateOrInsert(
            ['id' => (int) $row['id']],
            [
