...
class LibraryPaymentModeSeeder extends Seeder
{
   public function run(): void
   {
      $connection = env('DB_CONNECTION', 'mysql');
      $csvFile = database_path('seeders/csv/library_payment_mode.csv');
      ...
      foreach ($csv as $row) {
         DB::connection($connection)->table('library_payment_mode')->updateOrInsert(
            ['id' => (int) $row['id']],
            [
