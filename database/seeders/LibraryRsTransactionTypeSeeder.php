...
class LibraryRsTransactionTypeSeeder extends Seeder
{
   public function run(): void
   {
      $connection = env('DB_CONNECTION', 'mysql');
      $csvFile = database_path('seeders/csv/library_rs_transaction_types.csv');
      ...
      foreach ($csv as $row) {
         DB::connection($connection)->table('library_rs_transaction_types')->updateOrInsert(
            ['id' => (int) $row['id']],
            [
