...
class LibraryPayeeTypeSeeder extends Seeder
{
   public function run(): void
   {
      $connection = env('DB_CONNECTION', 'mysql');
      $csvFile = database_path('seeders/csv/library_payee_type.csv');
      ...
      foreach ($csv as $row) {
         DB::connection($connection)->table('library_payee_type')->updateOrInsert(
            ['id' => (int) $row['id']],
            [
