...
use App\Http\Controllers\FAReportController;
...
use App\Http\Controllers\Utility\PayeeController;
...
Route::middleware(['auth'])->controller(GlobalController::class)->group(function () {
   ...
   Route::get('/show_audits_by_filter', 'show_audits_by_filter')->name('show_audits_by_filter');
...
Route::middleware(['auth', 'role:Super Administrator|Administrator|Budget Officer'])->controller(LibraryExpenseAccountController::class)->group(function () {
   Route::get('/library_expense_account/table', 'table')->name('library_expense_account.table');
   Route::get('/library_expense_account/show', 'show')->name('library_expense_account.show');
   Route::post('/library_expense_account/store', 'store')->name('library_expense_account.store');
   Route::patch('/library_expense_account/update', 'update')->name('library_expense_account.update');
   Route::patch('/library_expense_account/delete', 'delete')->name('library_expense_account.delete');
});
...
Route::middleware(['auth', 'role:Super Administrator|Administrator|Budget Officer'])->controller(LibraryObjectSpecificController::class)->group(function () {
   Route::get('/library_object_specific/table', 'table')->name('library_object_specific.table');
   Route::get('/library_object_specific/show', 'show')->name('library_object_specific.show');
   Route::post('/library_object_specific/store', 'store')->name('library_object_specific.store');
   Route::patch('/library_object_specific/update', 'update')->name('library_object_specific.update');
   Route::patch('/library_object_specific/delete', 'delete')->name('library_object_specific.delete');
});
...
Route::middleware(['auth'])->prefix('utilities/')->name('utilities.')->group(function () {
   Route::resource('', UtilityController::class)->only([
      'index'
   ]);
...
Route::middleware(['auth'])->controller(ReportsController::class)->group(function () {
   Route::get('/reports/far1', 'far1')->name('far1');
});

Route::middleware(['auth', 'verified'])->prefix('reports/')->name('reports.')->group(function () {
   Route::resource('far', FAReportController::class)->only([
      'show',
   ]);
});

Route::middleware(['auth', 'verified'])->prefix('reports/')->name('reports.')
   ->controller(FAReportController::class)->group(function () {
      Route::get('far1/{year}', 'far1')->name('far1');
      Route::get('far1a/{year}', 'far1a')->name('far1a');
      Route::get('far1b/{year}', 'far1b')->name('far1b');
      Route::get('far1c/{year}', 'far1c')->name('far1c');
      Route::get('far2/{year}', 'far2')->name('far2');
      Route::get('far3/{year}', 'far3')->name('far3');
      Route::get('far4/{year}', 'far4')->name('far4');
      Route::get('cfar4/{year}', 'cfar4')->name('cfar4');
      Route::get('far5/{year}', 'far5')->name('far5');
      Route::get('far6/{year}', 'far6')->name('far6');
      Route::get('cfar6/{year}', 'cfar6')->name('cfar6');
      Route::get('bed3/{year}', 'bed3')->name('bed3');
   });

Route::middleware(['auth'])->controller(ReportsController::class)->group(function () {
   Route::get('/reports/financial_summary', 'financial_summary')->name('financial_summary');
   Route::get('/reports/show_financial_summary', 'show_financial_summary')->name('show_financial_summary');

   Route::get('/reports/dv_rs_particulars', 'dv_rs_particulars')->name('dv_rs_particulars');

   Route::get('/reports/rs_by_division', 'rs_by_division')->name('rs_by_division');
   ...
   Route::get('/reports/saob_summary/{rs}/{year}', 'saob_summary')->name('saob_summary');
   Route::get('/reports/allotment_summary_per_division_per_object_code/{rs}/{year}', 'allotment_summary_per_division_per_object_code')->name('allotment_summary_per_division_per_object_code');
...
Route::middleware(['auth', 'role:Super Administrator|Administrator|Budget Officer'])->controller(FiscalYearsController::class)->group(function () {
   ...
   Route::patch('/fiscal_years/open', 'open')->name('fiscal_years.open');
...
Route::middleware(['auth', 'role:Super Administrator|Administrator|Budget Officer|Executive Director|BPAC|BPAC Chair'])
   ->controller(AgencyBudgetProposalController::class)->group(function () {
      Route::get('/getBudgetProposals', 'getBudgetProposals')->name('agency_proposal.getBudgetProposals');
      ...
      Route::get('/budget_preparation/budget_proposal/agency_by_expenditure_tier1_fy1/{year}', 'agency_by_expenditure_tier1_fy1')->name('agency_proposal.agency_by_expenditure_tier1_fy1');
      Route::get('/budget_preparation/budget_proposal/summary_per_division/{year}', 'summary_per_division')->name('agency_proposal.summary_per_division');
      ...
      Route::get('/budget_preparation/budget_proposal/print_summary_per_division/{year}', 'print_summary_per_division')->name('agency_proposal.print_summary_per_division');
      Route::get('/budget_preparation/budget_proposal/print_agency_by_expenditure_tier1_fy1/{year}', 'print_agency_by_expenditure_tier1_fy1')->name('agency_proposal.print_agency_by_expenditure_tier1_fy1');
   });
