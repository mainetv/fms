{{-- table start --}}
  var library_expenditure_table = $('#library_expenditure_table').DataTable({
    processing: true,
    serverSide: true,
    responsive: true,
    lengthChange: false,
    ...
    dom: 'Bfrtip',
    ajax: {
      url: "{{ route('library_object_expenditure.table') }}",
      method: "GET",
      data : {
      '_token': '{{ csrf_token() }}'
      }
    ...
    columns: [      
      ...
      {data: 'object_code', name: 'object_code'},
