      ...
      <div class="card text-center">
         <div class="card-header">
           <ul class="nav nav-tabs" id="libraries_nav_tabs" role="tablist"> 
               ...
               <li class="nav-item">
                  <a href="#payees" class="nav-link active" id="payees_tab" data-toggle="tab" role="tab" aria-controls="payees" aria-selected="true">Payees
         ...
         <div class="card-body">
           <div class="tab-content" id="libraries">  
               <div class="tab-pane fade show active" id="payees" role="tabpanel" aria-labelledby="payees_tab">
                  @include('utilities.payee.index')                    
               </div>           
