  	...
  	<div class="col table-responsive">
		<table id="monthly_cash_program_table" class="table-bordered table-hover" style="width: 100%;">
			<thead class="text-center">
				<th style="min-width:150px">P/A/P / Object of Expenditures</th> 
				<th style="min-width:30px">Annual</th>
			...
			<tbody><?php	
				$data = DB::table('view_monthly_cash_programs')->where('cluster_id', $division_id)->where('year', $year_selected)
