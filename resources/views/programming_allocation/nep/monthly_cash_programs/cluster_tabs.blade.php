...
@section('content')
   ...
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0">Cluster Monthly Cash Program</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Cluster Monthly Cash Program</li>
            </ol>
            </div><!-- /.col -->
         </div><!-- /.row -->
      </div><!-- /.container-fluid -->
               ...
               <div class="col-6 col-sm-11">
                  ...
                  @foreach($clusters as $row => $value) 
                     <div role="tabpanel" @if($row == 0) class="tab-pane text-left fade in active show" 
                        ...
                        @include('programming_allocation.nep.monthly_cash_programs.cluster_tabs_content') 
                     </div>   
                  @endforeach   
                  </div>
               </div>
   ...
   <script type="text/javascript">     
      ...
      function changeYear()
		{         
			...
			window.location.replace("{{ url('programming_allocation/nep/monthly_cash_program/cluster') }}/"+year);
		}	
   </script>  
@endsection
