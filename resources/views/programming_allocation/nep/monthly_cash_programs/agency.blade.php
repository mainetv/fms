...
@section('content')
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
				<h1 class="m-0">Agency Monthly Cash Program</h1>
				</div>
				<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Agency Monthly Cash Program</li>
				</ol>
				</div>
			</div>
		</div>
		...
		<div class="card">			
			<div class="card-header noprint">
				<div class="row">
					...
					<div class="col-2">  
						{{-- <a target="_blank" href="{{ route('agency_mcp.generatePDF', $year_selected) }}" >
					...
					<div class="col table-responsive">
						<table id="monthly_cash_program_table" class="table-bordered table-hover" style="width: 100%;">
							<thead class="text-center">
								...
								<th style="min-width:130px">Annual</th>
								<th style="min-width:30px">Jan</th>
								<th style="min-width:30px">Feb</th>
								<th style="min-width:30px">Mar</th>										
								<th style="min-width:30px">Apr</th>										
								<th style="min-width:30px">May</th>										
								<th style="min-width:30px">Jun</th>										
								<th style="min-width:30px">Jul</th>										
								<th style="min-width:30px">Aug</th>										
								<th style="min-width:30px">Sep</th>										
								<th style="min-width:30px">Oct</th>										
								<th style="min-width:30px">Nov</th>										
								<th style="min-width:30px">Dec</th>	
							</thead>		
							<tbody><?php	
   ...
   <script type="text/javascript">     
      $(document).ready(function(){   
		...
		function changeYear()
		{
			...
			window.location.replace("{{ url('programming_allocation/nep/monthly_cash_program/agency') }}/"+year);
		}	 
   </script>  
@endsection
