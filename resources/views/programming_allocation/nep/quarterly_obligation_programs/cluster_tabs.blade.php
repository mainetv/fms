...
@section('content')
   ...
   <div class="content-header">
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0">Cluster Quarterly Obligation Program</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Cluster Quarterly Obligation Program</li>
            </ol>
            </div><!-- /.col -->
         </div><!-- /.row -->
      </div><!-- /.container-fluid -->
         ...
         <div class="card-body">
            <div class="row">
               <div class="col-4 col-sm-1">
                  ...
                  @foreach($clusters as $row => $value)   
                     <a href="#{{ $value->division_code }}" class="nav-link" aria-controls="{{ $value->division_code }}" role="tab"     
               ...
               <div class="col-6 col-sm-11">
                  ...
                  @foreach($clusters as $row => $value) 
                     <div role="tabpanel" @if($row == 0) class="tab-pane text-left fade in active show" 
                        ...
                        @include('programming_allocation.nep.quarterly_obligation_programs.cluster_tabs_content') 
                     </div>   
                  @endforeach   
                  </div>
               </div>
   ...
   <script type="text/javascript">     
      ...
      function changeYear()
		{         
			...
			window.location.replace("{{ url('programming_allocation/nep/quarterly_obligation_program/cluster') }}/"+year);
		}
   </script>  
@endsection
