...
@section('content')
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
				<h1 class="m-0">Agency Quarterly Obligation Program</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Agency Quarterly Obligation Program</li>
				</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
		...
		<div class="card">			
			<div class="card-header noprint">
				<div class="row">
					...
					<div class="col-2">  
						{{-- <a target="_blank" href="{{ route('agency_qop.generatePDF', $year_selected) }}" >
   ...
   <script type="text/javascript">     
      $(document).ready(function(){   
		...
		function changeYear()
		{
			...
			window.location.replace("{{ url('programming_allocation/nep/quarterly_obligation_program/agency') }}/"+year);
		}	 
   </script>  
@endsection
