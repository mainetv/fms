			...
			<div class="card-header row">
				<div class="col-11">
					<h5 class="font-weight-bold">
						Allotment Summary per Division per Object Code
					</h5> 
				</div>
				<div class="col-1">    
...
@section('jscript')
	<script type="text/javascript">   
		...
		$('.select_filter').on('change', function(){
			...
			window.location.replace("{{ url('reports/allotment_summary_per_division_per_object_code') }}/"+rstype_id_selected+"/"+year_selected);
		})
