		...
		function loadRecords(payment_mode_selected, fund_id_selected, start_date, end_date){	
			var records_table = $('#records_table').DataTable({				
				...
				columns: [
					...
					{data: 'total_tax', title: 'Tax', width: '4%', className: 'dt-head-center dt-body-right',
						render: $.fn.dataTable.render.number(',', '.', 2, '')
					},
					{data: 'total_other_deductions', title: 'Other Deductions', width: '4%', className: 'dt-head-center dt-body-right',
						render: $.fn.dataTable.render.number(',', '.', 2, '')
					},
