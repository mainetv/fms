	...
	<script type="text/javascript">   
		...
		function loadRecords(payment_mode_selected, fund_id_selected, start_date, end_date){	
			var records_table = $('#records_table').DataTable({				
				...
				scroller: true,
				ajax: {
					url: "{{ route('show_ada_check_per_payee') }}",
					method: "GET",
					data : {
						'_token': '{{ csrf_token() }}',
				...
				columns: [					
					...
					{data: 'other_deductions', title: 'Other Deductions', width: '3%', className: 'dt-head-center dt-body-right',
						render: $.fn.dataTable.render.number(',', '.', 2, '')
					},
