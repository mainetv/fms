			...
			<div class="card-header row">
				<div class="col-10">
					<h5 class="font-weight-bold">
						Statement of Appropiations, Allotments, Obligations, Disbursements and Balances (FAR 1C)
					</h5> 
				</div>
						...
						<div class="col table-responsive">
							<table width="100%" class="table-hover table2excel" id="tbl_far1" style="font-size: 11px;">
								<thead class="text-center">
									<tr>
										<th rowspan="3">Implementing Agencies and Projects</th>
										<th colspan="7">Obligations</th>
										<th colspan="5">Disbursements (Funds Transferred To)</th>										
										<th colspan="5">Liquidations</th>
										<th rowspan="3">Unpaid Obligations</th>
										<th rowspan="3">Unliquidated Fund Transfers</th>
									</tr>
									<tr>
										<th colspan="2">Obligation Request and Status</th>
								...
								<tbody>
									...
									@foreach($data->groupBy('allotment_reference_id') as $key=>$row)										
										...
										<tr class="text-right">
											...
											<td>{{ $item->allotment_received_dbm }}</td>	
