    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="ors_modal_header">Add ORS</h5>
        ...
        <form id="ors_form">     
          <div class="modal-body">   
            ...
            <div class="form-group row">
              <label for="rs_id" class="col-sm-1 col-form-label">ORS ID</label>
              <div class="col-sm-4"> 
                <input type="text" name="rs_id" id="rs_id" class="form-control no-border" readonly>
              </div>  
              <label for="rs_no" class="col-sm-1 col-form-label">ORS No. <span id="generate_rs_no" class="d-none"><a href="#"> >> </a></span></label>
              <div class="col"> 
