								...
								@role('Division Budget Controller')
									<th class="text-center" style="min-width: 3%; max-width: 3%;">		
										<a href="{{ url('funds_utilization/rs/add/'.$rs_type_id) }}" data-toggle="tooltip" data-placement='left'
											title='Add BURS-CFITF' data-division-id="{{ $division_id }}" data-year="{{ $year_selected }}">								
...
@section('jscript')
   <script type="text/javascript">   
      $(document).ready(function(){ 
         @include('funds_utilization.burs_cfitf.script')   
		...
		{         
         ...
         year = $("#year_selected").val();
			window.location.replace("{{ url('funds_utilization/rs/division/burs-cfitf') }}/"+month+"/"+year);
		}
