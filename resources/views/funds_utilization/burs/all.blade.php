...
@section('content')
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
				<h1 class="m-0">Budget Utilization Request and Status (BURS)</h1>
				</div>
				<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="/fms/public">Home</a></li>
						<li class="breadcrumb-item active">Funds Utilization</li>
						<li class="breadcrumb-item active">Budget Utilization Request and Status (BURS)</li>
				</ol>
				</div>
			</div>
		</div>
      ...
      $(document).ready(function(){    
		...
		function changeFilter(){         
         ...
         year = $("#year_selected").val();
			window.location.replace("{{ url('funds_utilization/rs/all/burs') }}/"+month+"/"+year);
		}
		...
		function loadRecords(){	
			...
			var rs_table = $('#rs_table').DataTable({
				...
				columns: [  
					...
					{data: 'rs_no', title: 'BURS No.', width: '12%', className: 'dt-center'},
					{data: 'division_acronym', title: 'Responsibility Center', width: '8%', className: 'dt-center'},
					{data: 'payee', title: 'Payee', width: '22%', className: 'dt-head-center'},
					{data: 'particulars', title: 'Particulars', width: '40%', className: 'dt-head-center'},
					{data: 'total_rs_activity_amount', title: 'Amount', width: '11%', className: 'dt-head-center dt-body-right',
