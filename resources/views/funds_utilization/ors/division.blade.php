					...
					<div class="col table-responsive">
						<table id="rs_table" class="table-bordered table-hover" style="width: 100%;">
							<thead class="text-center">
								<th>ID</th>
								<th nowrap style="min-width: 7%; max-width: 7%;">ORS Date</th>
								<th nowrap style="min-width: 12%; max-width: 12%;">ORS No.</th>
								...
								@role('Division Budget Controller')
									<th class="text-center" style="min-width: 3%; max-width: 3%;">		
										<a href="{{ url('funds_utilization/rs/add/'.$rs_type_id) }}" data-toggle="tooltip" data-placement='left'
											title='Add ORS' data-division-id="{{ $division_id }}" data-year="{{ $year_selected }}">								
   ...
   <script type="text/javascript">   
      ...
      function changeFilter(){         
         ...
         year = $("#year_selected").val();
			window.location.replace("{{ url('funds_utilization/rs/division/ors') }}/"+month+"/"+year);
		}
