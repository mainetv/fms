      ...
      $(document).ready(function(){ 
		...
		function changeFilter(){         
         ...
         year = $("#year_selected").val();
			window.location.replace("{{ url('funds_utilization/rs/all/ors') }}/"+month+"/"+year);
		}
...
serverSide: true,
				...
				order: [[2, 'asc']],
				columns: [  
					{data: 'rs_date', title: 'ORS Date', width: '7%',className: 'dt-center'}, 
					{data: 'rs_no', title: 'ORS No.', width: '12%', className: 'dt-center'},
