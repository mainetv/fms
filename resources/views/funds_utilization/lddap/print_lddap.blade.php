  ...
  <body>
    ...
    <div class="display_screen">
      <table width="100%" cellspacing="0" cellpadding="3" class="table-borderless">
        <tr>
          <td height="32" colspan="2" valign="top" class="deffont text-center">
            <strong>LIST OF DUE AND DEMANDABLE ACCOUNTS PAYABLE-INTERNAL CREDITORS</strong></td>
        </tr>
        <tr>
          <td><span class="midfont">DEPARTMENT</span></td>
          <td><span class="midfont">Department of Science and Technology</span></td>
        </tr>
        <tr>
          <td><span class="midfont">AGENCY</span></td>
          <td><span class="smallfont"><strong>PHILIPPINE COUNCIL FOR AGRICULTURE, AQUATIC AND NATURAL RESOURCES RESEARCH AND DEVELOPMENT</strong></span></td>
        </tr>
        <tr>
          <td><span class="midfont">MDS ACCOUNT</span></td>
        ...
        <tr>
          <td width="15%"><span class="midfont">NCA NO.</span></td>
          <td width="85%">{{ $nca_no }}</td>
        </tr>
      </table>
      <table width="100%" border="1" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="5" align="center"><span class="midfont">C R E D I T O R</span></td>
          <td colspan="4" align="center"><span class="midfont">In PESOS</span></td>
        </tr>
        <tr class="text-center">
          <td width="3%">&nbsp;</td>
          <td width="23%"><span class="midfont">NAME</span></td>
          <td width="16%"><span class="midfont">PREFERRED SERVICING<br /> BANK/SAVINGS/CURRENT<br />  ACCT. NO.</span></td>
          <td width="15%"><span class="midfont">Obligation<br /> Request<br /> No.</span></td>
          <td width="6%"><span class="midfont">ALLOTMENT<br />CLASS/<br /> OBJECT</span></td>
...
$total_tax = 0;
        ...
        <tr class="text-right font-weight-bold">
          ...
          <td>@if($other_deductions > 0) {{ number_format($other_deductions,2) }} @endif</td>
        ...
        <tr>
          <td style="padding-left:5px; padding-right:5px">
            <table width="100%" class="table-borderless" cellspacing="0" cellpadding="0">
              <tr>
                <td width="49%" valign="top"><span class="midfontb">I hereby warrant that the above List of Due and Demandable A/Ps was prepared in accordance with existing budgeting, accounting and auditing rules and regulations.</span></td>
                <td width="3%" valign="top">&nbsp;</td>
                <td width="48%" valign="top"><span class="midfontb">I hereby assume the responsibility for the veracity and accuracy of the listed claims, and the authenticity of the supporting documents as submitted by the claimants</span></td>
              </tr>
              <tr>
                <td valign="top" style="border-bottom-style:solid; border-bottom-width:thin"><p><span class="midfontb">Certified Correct:</span></p><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ strtoupper($signatory1) }}<br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $signatory1_position }}</strong></td>
                <td valign="top" style="border-bottom-style:solid; border-bottom-width:thin">&nbsp;</td>
                <td valign="top" style="border-bottom-style:solid; border-bottom-width:thin"><p><span class="midfontb">Approved:<br />
                </span></p><span class="midfont"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ strtoupper($signatory2) }}<br />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $signatory2_position }}</strong></span></td>
              </tr>
            </table>
            <table width="100%" class="table-borderless" cellspacing="0" cellpadding="0">
              <tr>
