     ...
     <div class="modal-content">
       ...
       <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" id="library_activity" name="library_activity" class="form-control library-activity-field"  required>
         ...
         <div class="form-group">
          ...
          <div class="form-check form-check-inline">
            ...
            <input type="checkbox" id="library_subactivity_is_continuing" name="library_subactivity_is_continuing" class="form-check-input library-subactivity-field" 
