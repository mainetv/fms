        ...
        <form id="save_comment_form"> 
          ...
          <div class="modal-body">                              
            <div class="form-group" >               
              ...
              By Division Director   <button data-toggle="tooltip" data-placement="auto" title="Add Comment"
              @if ($user_role_id==6) class="add-row-director btn-sm"
          ...
          <div class="modal-footer">
            ...
            @if($user_role_id==6 || $user_role_id==3) class="update btn btn-primary save-buttons save_comment"
