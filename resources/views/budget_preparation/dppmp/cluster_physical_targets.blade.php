		...
		<div class="card refreshDiv">			
			<div class="card-header">
				<div class="row">
					...
					?> 					             
					<div class="col-2">
						<a target="_blank" href="{{ route('physical_targets.generatePDF', ['division_id'=>$division_id, 'year'=>$year]) }}" >
   ...
   <script type="text/javascript">     
      $(document).ready(function(){    
		...
		function changeYear()
		{
			...
			window.location.replace("{{ url('budget_preparation/physical_targets/cluster') }}/"+year);
		}		  
   </script>  
@endsection
