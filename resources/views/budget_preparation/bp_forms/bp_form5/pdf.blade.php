...
<html>
	...
	{{-- tier 1 fy1--}}
		...
		<h5 class="text-center">CAPITAL OUTLAY - MACHINERIES AND EQUIPMENT - Tier 1</h5>
			...
			<div class="col table-responsive">  
				<table id="bp_form5_table_fy1" class="table-bordered table-hover table" style="width: 100%;">
					...
					<tbody>
						<?php 
							$count_fy1 = 0;			
							$sqlBpForm5byFY_fy1 = getBpForm5byDivisionbyYearbyTier($user_division_id, '1', $year);
			...
			<div class="col table-responsive">  
				<table id="bp_form5_table_fy2" class="table-bordered table-hover table" style="width: 100%;">
					...
					<tbody>
						<?php 
							$count_fy2 = 0;			
							$sqlBpForm5byFY_fy2 = getBpForm5byDivisionbyYearbyTier($user_division_id, '1', $year);
			...
			<div class="col table-responsive">  
				<table id="bp_form5_table_fy3" class="table-bordered table-hover table" style="width: 100%;">
					...
					<tbody>
						<?php 
							$count_fy3 = 0;			
							$sqlBpForm5byFY_fy3 = getBpForm5byDivisionbyYearbyTier($user_division_id, '1', $year);
							foreach($sqlBpForm5byFY_fy3 as $row){
								...
								$remarks = $row->remarks;
								$is_active = $row->is_active;
								$count_fy3 = count($sqlBpForm5byFY_fy3);
								$unit_cost = round($row->unit_cost, -3)/1000;
								$total_cost = round($row->total_cost, -3)/1000;
								$fiscal_year = $row->fiscal_year;
	...
	{{-- tier 2 fy1--}}
		<h5 class="text-center">{{ $department_header }}</h5>
		<h5 class="text-center">{{ $agency_header }}</h5>
		<h5 class="text-center">CAPITAL OUTLAY - MACHINERIES AND EQUIPMENT - Tier 2</h5>
		<h6 class="text-center">(In Thousand Pesos)</h6>		
			<div class="row">
			<div class="col-10">
				<div class="float-right"><?php 
			...
			<div class="col table-responsive">  
				<table id="bp_form5_table_fy1" class="table-bordered table-hover table" style="width: 100%;">
					...
					<tbody>
						<?php 
							$count_fy1 = 0;			
							$sqlBpForm5byFY_fy1 = getBpForm5byDivisionbyYearbyTier($user_division_id, '2', $year);
							foreach($sqlBpForm5byFY_fy1 as $row){
								$id = $row->id;
								$description = $row->description;
								$quantity = $row->quantity;
			...
			<div class="col table-responsive">  
				<table id="bp_form5_table_fy2" class="table-bordered table-hover table" style="width: 100%;">
					...
					<tbody>
						<?php 
							$count_fy2 = 0;			
							$sqlBpForm5byFY_fy2 = getBpForm5byDivisionbyYearbyTier($user_division_id, '2', $year);
							foreach($sqlBpForm5byFY_fy2 as $row){
								$id = $row->id;
								$description = $row->description;
								$quantity = $row->quantity;
			...
			<div class="col table-responsive">  
				<table id="bp_form5_table_fy3" class="table-bordered table-hover table" style="width: 100%;">
					...
					<tbody>
						<?php 
							$count_fy3 = 0;			
							$sqlBpForm5byFY_fy3 = getBpForm5byDivisionbyYearbyTier($user_division_id, '2', $year);
							foreach($sqlBpForm5byFY_fy3 as $row){
								$id = $row->id;
								$description = $row->description;
								$quantity = $row->quantity;
